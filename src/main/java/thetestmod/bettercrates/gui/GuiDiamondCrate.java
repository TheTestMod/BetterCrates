...
public class GuiDiamondCrate extends GuiContainer {
	...
	public GuiDiamondCrate(Container container, InventoryPlayer playerInv) {
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		...
		String name = I18n.format(BlocksRegistry.DIAMOND_CRATE.getUnlocalizedName() + ".name");

...
public class GuiObsidianCrate extends GuiContainer {

	private static final ResourceLocation BG_TEXTURE = new ResourceLocation(BetterCrates.MODID,
			"textures/gui/Diamond_crate.png");

	private InventoryPlayer playerInv;

	public GuiObsidianCrate(Container container, InventoryPlayer playerInv) {
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		...
		String name = I18n.format(BlocksRegistry.OBSIDIAN_CRATE.getUnlocalizedName() + ".name");

...
public class TinCrate extends BlockTileEntity<TileEntityTinCrate> {

	public TinCrate(String name, Material material, SoundType sound) {
	...
	@Override
	public Class<TileEntityTinCrate> getTileEntityClass() {
		return TileEntityTinCrate.class;
	}

	@Nullable
	@Override
	public TileEntityTinCrate createTileEntity(World world, IBlockState state) {
		return new TileEntityTinCrate();
	}
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand,
		...
		if (!world.isRemote) {
			...
			TileEntityTinCrate tile = getTileEntity(world, pos);
			IItemHandler itemHandler = tile.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, side);
			player.openGui(BetterCrates.instance, GuiRegistry.TIN_CRATE, world, pos.getX(), pos.getY(), pos.getZ());
		}
		return true;
	}
	...
	public List<ItemStack> getDrops(IBlockAccess w, BlockPos pos, IBlockState s, int f) {
		...
		if (te instanceof TileEntityTinCrate) {
			ItemStack stack = new ItemStack(Item.getItemFromBlock(this));
			NBTTagCompound tagCompound = new NBTTagCompound();
			((TileEntityTinCrate) te).writeRestorableToNBT(tagCompound);
	...
	public void onBlockPlacedBy(World w, BlockPos pos, IBlockState s, EntityLivingBase p, ItemStack is) {
		...
		if (tagCompound != null) {
			TileEntity te = w.getTileEntity(pos);
			if (te instanceof TileEntityTinCrate)
				((TileEntityTinCrate) te).readRestorableFromNBT(tagCompound);
		}
	}

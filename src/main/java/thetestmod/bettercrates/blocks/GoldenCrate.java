...
public class GoldenCrate extends BlockTileEntity<TileEntityGoldenCrate> {

	public GoldenCrate(String name, Material material, SoundType sound) {
	...
	@Override
	public Class<TileEntityGoldenCrate> getTileEntityClass() {
		return TileEntityGoldenCrate.class;
	}

	@Nullable
	@Override
	public TileEntityGoldenCrate createTileEntity(World world, IBlockState state) {
		return new TileEntityGoldenCrate();
	}
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand,
		...
		if (!world.isRemote) {
			...
			TileEntityGoldenCrate tile = getTileEntity(world, pos);
			IItemHandler itemHandler = tile.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, side);
			player.openGui(BetterCrates.instance, GuiRegistry.GOLDEN_CRATE, world, pos.getX(), pos.getY(), pos.getZ());
		}
		return true;
	}
	...
	public List<ItemStack> getDrops(IBlockAccess w, BlockPos pos, IBlockState s, int f) {
		...
		if (te instanceof TileEntityGoldenCrate) {
			ItemStack stack = new ItemStack(Item.getItemFromBlock(this));
			NBTTagCompound tagCompound = new NBTTagCompound();
			((TileEntityGoldenCrate) te).writeRestorableToNBT(tagCompound);
	...
	public void onBlockPlacedBy(World w, BlockPos pos, IBlockState s, EntityLivingBase p, ItemStack is) {
		...
		if (tagCompound != null) {
			TileEntity te = w.getTileEntity(pos);
			if (te instanceof TileEntityGoldenCrate)
				((TileEntityGoldenCrate) te).readRestorableFromNBT(tagCompound);
		}
	}

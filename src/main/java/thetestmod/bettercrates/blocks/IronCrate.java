...
public class IronCrate extends BlockTileEntity<TileEntityIronCrate> {

	public IronCrate(String name, Material material, SoundType sound) {
	...
	@Override
	public Class<TileEntityIronCrate> getTileEntityClass() {
		return TileEntityIronCrate.class;
	}

	@Nullable
	@Override
	public TileEntityIronCrate createTileEntity(World world, IBlockState state) {
		return new TileEntityIronCrate();
	}
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand,
		...
		if (!world.isRemote) {
			...
			TileEntityIronCrate tile = getTileEntity(world, pos);
			IItemHandler itemHandler = tile.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, side);
			player.openGui(BetterCrates.instance, GuiRegistry.IRON_CRATE, world, pos.getX(), pos.getY(), pos.getZ());
		}
		return true;
	}
	...
	public List<ItemStack> getDrops(IBlockAccess w, BlockPos pos, IBlockState s, int f) {
		...
		if (te instanceof TileEntityIronCrate) {
			ItemStack stack = new ItemStack(Item.getItemFromBlock(this));
			NBTTagCompound tagCompound = new NBTTagCompound();
			((TileEntityIronCrate) te).writeRestorableToNBT(tagCompound);
	...
	public void onBlockPlacedBy(World w, BlockPos pos, IBlockState s, EntityLivingBase p, ItemStack is) {
		...
		if (tagCompound != null) {
			TileEntity te = w.getTileEntity(pos);
			if (te instanceof TileEntityIronCrate)
				((TileEntityIronCrate) te).readRestorableFromNBT(tagCompound);
		}
	}
